...
// hero and enemies health detection and print
...
// all these are details shown in start of game loading from txt files
...
// these are the functions to store and load hero location health and score
...
// these are the functions to store and load mr fighter(big enemy) location and health
...
// these are the functions to store and load mr Purple(enemy) location and health
...
// these are the functions to store and load mr Blue(enemy) location and health
...
// as clear from names all these are load and display supporting functions
void displaymaze(char array[][72], int size)
{
...
// hero functions to print erase move store and load , generate print move erase bullets and detect health while stop
void hero_stop_health(int &herox, int &heroy, int &health)
{
...
// enmey 3 functions to print erase move generate , print erase and move bullets store and load
void printEnemy(char enemy[][6], int size1, int enemyx, int enemyy, char array[][72], int size, string &enemydirection)
{
    HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
    int k = 10;
...
// enmey 2 functions to print erase move store and load
void printEnemy2(char array[][72], int size, char enemy2[][2], int e2_size, int &enemy2x, int &enemy2y, string &direction2)
{
    HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
    int k = 9;
...
// enmey 3 functions to print erase move store and load
void printEnemy3(char array[][72], int size, char enemy3[][2], int e3_size, int &enemy3x, int &enemy3y, string &direction3)
{
    HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
    int k = 5;
...
{
    gotoxy(75, 15);
    cout << "MR_BULLET aka HERO Score: " << score; /// printing enemy hero health and score
    gotoxy(75, 16);
