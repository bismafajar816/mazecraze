...
void deletebulletfromarray(int &enemyx, int &enemyy);
void printBullet2(int &enemyx, int &enemyy);
void eraseBullet2(int &enemyx, int &enemyy);
void generateBullet2(int &enemyx, int &enemyy);

void moveBullet2(int &enemyx, int &enemyy);
...
void generateBullet2(int &enemyx, int &enemyy)
{
    ...
    int k = 8;
    SetConsoleTextAttribute(hConsole, k);
    bulletX2[bulletCount] = enemyx + 7;
    bulletY2[bulletCount] = enemyy;
...
void printBullet2(int bulletx, int bullety)
{
    gotoxy(bulletx, bullety);
    cout << "o";
}
void eraseBullet2(int bulletx, int bullety)
{
    gotoxy(bulletx, bullety);
    cout << " ";
}
